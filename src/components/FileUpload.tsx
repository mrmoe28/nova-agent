...
import { Upload, FileText, X, Loader2, AlertCircle, CheckCircle, Clock } from "lucide-react"
              ...
              <>
                ...
                <div className="relative">
                  <div className={cn(
                    ...
                    <Upload className={cn(
                      ...
                      dragActive ? "text-white" : "text-gray-400 dark:text-gray-600"
                    )} />
                  </div>
                  {dragActive && (
                ...
                <Alert className="max-w-md bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
                  ...
                  <AlertDescription className="text-sm text-blue-800 dark:text-blue-300">
                    <strong>Supports:</strong> PDF, JPG, PNG, CSV (max 10MB per file)
                    <br />
                    <strong>Recommended:</strong> PDF files for best OCR accuracy
                  </AlertDescription>
                </Alert>
