...
export const SYSTEM_SIZING = {
  ...
  INSTALLATION_BASE_COST: parseFloat(process.env.INSTALLATION_BASE_COST || '5000'),
} as const
...
export const SCRAPER_CONFIG = {
  ...
  USER_AGENT_ID: process.env.SCRAPER_USER_AGENT || 'NovaAgent/1.0 (+https://novaagent-kappa.vercel.app)',
} as const
...
export const BROWSER_CONFIG = {
  ...
  BROWSERLESS_ENDPOINT: process.env.BROWSERLESS_ENDPOINT || 'https://production-sfo.browserless.io/chromium/bql',
...
export const AI_CONFIG = {
  ...
  MAX_DIAGNOSIS_TOKENS: parseInt(process.env.CLAUDE_MAX_DIAGNOSIS_TOKENS || '1500'),
...
export const UPLOAD_CONFIG = {
  ...
  MAX_FILE_SIZE: parseInt(process.env.MAX_FILE_SIZE || (10 * 1024 * 1024).toString()),

  /** Allowed file types */
  ALLOWED_FILE_TYPES: (process.env.ALLOWED_FILE_TYPES || 'pdf,png,jpg,jpeg,csv').split(','),
} as const
...
export const CACHE_CONFIG = {
  ...
  ROBOTS_TXT_TIMEOUT: parseInt(process.env.CACHE_ROBOTS_TIMEOUT || (24 * 60 * 60 * 1000).toString()),
} as const
